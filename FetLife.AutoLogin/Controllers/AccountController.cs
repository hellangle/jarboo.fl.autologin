...
using FetLife.AutoLogin.Models;
using System.Net;
...
namespace FetLife.AutoLogin.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(@"https://fetlife.com/users/sign_in");
            ...
            using (StreamReader sr = new StreamReader(resp.GetResponseStream()))
            {
                ...
                loginData = $"utf8={encoding}&authenticity_token={crtf}&user[otp_attempt]=step_1&user[locale]=en&user[login]=hellangle381&user[password]=12345678";
            }

            request = (HttpWebRequest)WebRequest.Create(@"https://fetlife.com/users/sign_in");
            request.Method = "POST";
            ...
            request.CookieContainer = cc;
            request.Headers.Add(HttpRequestHeader.Cookie, cc.GetCookieHeader(new Uri("https://fetlife.com")));
            ...
            request = (HttpWebRequest)WebRequest.Create(@"https://fetlife.com/home");
            request.Method = "GET";
            request.CookieContainer = cc;
            ...
            {
                string pageSource = sr.ReadToEnd();
                return Content(pageSource, "text/html");
